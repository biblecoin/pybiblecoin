import rlp
from biblecoin.utils import normalize_address, hash32, trie_root, \
...
from biblecoin.trie import Trie
from biblecoin.securetrie import SecureTrie
from biblecoin.config import default_config, Env
from biblecoin.block import FakeHeader
from biblecoin.db import BaseDB, EphemDB, OverlayDB, RefcountDB
...
class State():
    ...
    def revert(self, snapshot):
        ...
        # Compatibility with weird BibleCoind+parity bug
        ...
        if three_touched and 2675000 < self.block_number < 2675200:  # Compatibility with weird BibleCoind+parity bug
