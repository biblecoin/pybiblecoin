...
pybiblecoin follows a **maximally state-centric model**; the ONLY
...
Biblecoin have the option to output an ABI declaration for a program.
...
The pybiblecoin codebase is designed to be maximally friendly for use
...
Run ``python3.6 -m pytest biblecoin/tests/<filename>`` for any .py file
